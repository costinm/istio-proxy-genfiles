...
inline void InitDefaults() {
  InitDefaultsPipe();
  InitDefaultsSocketAddress();
  InitDefaultsBindConfig();
  InitDefaultsAddress();
  InitDefaultsCidrRange();
}
}  // namespace protobuf_api_2faddress_2eproto
namespace envoy {
namespace api {
...
extern CidrRangeDefaultTypeInternal _CidrRange_default_instance_;
class Pipe;
...
class Pipe : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Pipe) */ {
 ...
 private:
  ...
  friend void ::protobuf_api_2faddress_2eproto::InitDefaultsPipeImpl();
};
// -------------------------------------------------------------------
...
class SocketAddress : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.SocketAddress) */ {
 ...
 private:
  ...
  friend struct ::protobuf_api_2faddress_2eproto::TableStruct;
  friend void ::protobuf_api_2faddress_2eproto::InitDefaultsSocketAddressImpl();
};
// -------------------------------------------------------------------
...
class BindConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.BindConfig) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2faddress_2eproto::TableStruct;
  friend void ::protobuf_api_2faddress_2eproto::InitDefaultsBindConfigImpl();
};
// -------------------------------------------------------------------
...
class Address : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Address) */ {
 ...
 private:
  ...
  friend struct ::protobuf_api_2faddress_2eproto::TableStruct;
  friend void ::protobuf_api_2faddress_2eproto::InitDefaultsAddressImpl();
};
// -------------------------------------------------------------------

class CidrRange : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.CidrRange) */ {
 public:
  CidrRange();
  virtual ~CidrRange();

  CidrRange(const CidrRange& from);

  inline CidrRange& operator=(const CidrRange& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  CidrRange(CidrRange&& from) noexcept
    : CidrRange() {
    *this = ::std::move(from);
  }

  inline CidrRange& operator=(CidrRange&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const CidrRange& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const CidrRange* internal_default_instance() {
    return reinterpret_cast<const CidrRange*>(
               &_CidrRange_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    4;

  void Swap(CidrRange* other);
  friend void swap(CidrRange& a, CidrRange& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline CidrRange* New() const PROTOBUF_FINAL { return New(NULL); }

  CidrRange* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const CidrRange& from);
  void MergeFrom(const CidrRange& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(CidrRange* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2faddress_2eproto::TableStruct;
  friend void ::protobuf_api_2faddress_2eproto::InitDefaultsCidrRangeImpl();
};
// ===================================================================
...
inline const ::std::string& CidrRange::address_prefix() const {
  // @@protoc_insertion_point(field_get:envoy.api.v2.CidrRange.address_prefix)
  return address_prefix_.GetNoArena();
}
inline void CidrRange::set_address_prefix(const ::std::string& value) {
  
  address_prefix_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:envoy.api.v2.CidrRange.address_prefix)
}
#if LANG_CXX11
inline void CidrRange::set_address_prefix(::std::string&& value) {
  
  address_prefix_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:envoy.api.v2.CidrRange.address_prefix)
}
#endif
inline void CidrRange::set_address_prefix(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  address_prefix_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:envoy.api.v2.CidrRange.address_prefix)
}
inline void CidrRange::set_address_prefix(const char* value, size_t size) {
  
  address_prefix_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:envoy.api.v2.CidrRange.address_prefix)
}
inline ::std::string* CidrRange::mutable_address_prefix() {
  
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.CidrRange.address_prefix)
  return address_prefix_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CidrRange::release_address_prefix() {
  // @@protoc_insertion_point(field_release:envoy.api.v2.CidrRange.address_prefix)
  
  return address_prefix_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void CidrRange::set_allocated_address_prefix(::std::string* address_prefix) {
