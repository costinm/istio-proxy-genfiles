...
inline void InitDefaults() {
  InitDefaultsUpstreamBindConfig();
  InitDefaultsCircuitBreakers_Thresholds();
  InitDefaultsCircuitBreakers();
  InitDefaultsCluster_EdsClusterConfig();
  InitDefaultsCluster_OutlierDetection();
  InitDefaultsCluster_LbSubsetConfig_LbSubsetSelector();
  InitDefaultsCluster_LbSubsetConfig();
  InitDefaultsCluster_RingHashLbConfig_DeprecatedV1();
  InitDefaultsCluster_RingHashLbConfig();
  InitDefaultsCluster();
}
}  // namespace protobuf_api_2fcds_2eproto
namespace envoy {
...
class Cluster_LbSubsetConfig;
class Cluster_LbSubsetConfigDefaultTypeInternal;
extern Cluster_LbSubsetConfigDefaultTypeInternal _Cluster_LbSubsetConfig_default_instance_;
class Cluster_LbSubsetConfig_LbSubsetSelector;
class Cluster_LbSubsetConfig_LbSubsetSelectorDefaultTypeInternal;
extern Cluster_LbSubsetConfig_LbSubsetSelectorDefaultTypeInternal _Cluster_LbSubsetConfig_LbSubsetSelector_default_instance_;
...
class Cluster_RingHashLbConfig;
class Cluster_RingHashLbConfigDefaultTypeInternal;
extern Cluster_RingHashLbConfigDefaultTypeInternal _Cluster_RingHashLbConfig_default_instance_;
class Cluster_RingHashLbConfig_DeprecatedV1;
class Cluster_RingHashLbConfig_DeprecatedV1DefaultTypeInternal;
extern Cluster_RingHashLbConfig_DeprecatedV1DefaultTypeInternal _Cluster_RingHashLbConfig_DeprecatedV1_default_instance_;
...
enum Cluster_LbSubsetConfig_LbSubsetFallbackPolicy {
  Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_NO_FALLBACK = 0,
  Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_ANY_ENDPOINT = 1,
  Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_DEFAULT_SUBSET = 2,
  Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_IsValid(int value);
const Cluster_LbSubsetConfig_LbSubsetFallbackPolicy Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_LbSubsetFallbackPolicy_MIN = Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_NO_FALLBACK;
const Cluster_LbSubsetConfig_LbSubsetFallbackPolicy Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_LbSubsetFallbackPolicy_MAX = Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_DEFAULT_SUBSET;
const int Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_LbSubsetFallbackPolicy_ARRAYSIZE = Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_LbSubsetFallbackPolicy_MAX + 1;

const ::google::protobuf::EnumDescriptor* Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_descriptor();
inline const ::std::string& Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_Name(Cluster_LbSubsetConfig_LbSubsetFallbackPolicy value) {
  return ::google::protobuf::internal::NameOfEnum(
    Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_descriptor(), value);
}
inline bool Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_Parse(
    const ::std::string& name, Cluster_LbSubsetConfig_LbSubsetFallbackPolicy* value) {
  return ::google::protobuf::internal::ParseNamedEnum<Cluster_LbSubsetConfig_LbSubsetFallbackPolicy>(
    Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_descriptor(), name, value);
}
...
class UpstreamBindConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.UpstreamBindConfig) */ {
 ...
 private:
  ...
  friend void ::protobuf_api_2fcds_2eproto::InitDefaultsUpstreamBindConfigImpl();
};
// -------------------------------------------------------------------
...
class CircuitBreakers_Thresholds : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.CircuitBreakers.Thresholds) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fcds_2eproto::TableStruct;
  friend void ::protobuf_api_2fcds_2eproto::InitDefaultsCircuitBreakers_ThresholdsImpl();
};
// -------------------------------------------------------------------
...
class CircuitBreakers : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.CircuitBreakers) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fcds_2eproto::TableStruct;
  friend void ::protobuf_api_2fcds_2eproto::InitDefaultsCircuitBreakersImpl();
};
// -------------------------------------------------------------------
...
class Cluster_EdsClusterConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Cluster.EdsClusterConfig) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fcds_2eproto::TableStruct;
  friend void ::protobuf_api_2fcds_2eproto::InitDefaultsCluster_EdsClusterConfigImpl();
};
// -------------------------------------------------------------------
...
class Cluster_LbSubsetConfig_LbSubsetSelector : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector) */ {
 public:
  Cluster_LbSubsetConfig_LbSubsetSelector();
  virtual ~Cluster_LbSubsetConfig_LbSubsetSelector();

  Cluster_LbSubsetConfig_LbSubsetSelector(const Cluster_LbSubsetConfig_LbSubsetSelector& from);

  inline Cluster_LbSubsetConfig_LbSubsetSelector& operator=(const Cluster_LbSubsetConfig_LbSubsetSelector& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  Cluster_LbSubsetConfig_LbSubsetSelector(Cluster_LbSubsetConfig_LbSubsetSelector&& from) noexcept
    : Cluster_LbSubsetConfig_LbSubsetSelector() {
    *this = ::std::move(from);
  }

  inline Cluster_LbSubsetConfig_LbSubsetSelector& operator=(Cluster_LbSubsetConfig_LbSubsetSelector&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const Cluster_LbSubsetConfig_LbSubsetSelector& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Cluster_LbSubsetConfig_LbSubsetSelector* internal_default_instance() {
    return reinterpret_cast<const Cluster_LbSubsetConfig_LbSubsetSelector*>(
               &_Cluster_LbSubsetConfig_LbSubsetSelector_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    5;

  void Swap(Cluster_LbSubsetConfig_LbSubsetSelector* other);
  friend void swap(Cluster_LbSubsetConfig_LbSubsetSelector& a, Cluster_LbSubsetConfig_LbSubsetSelector& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline Cluster_LbSubsetConfig_LbSubsetSelector* New() const PROTOBUF_FINAL { return New(NULL); }

  Cluster_LbSubsetConfig_LbSubsetSelector* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const Cluster_LbSubsetConfig_LbSubsetSelector& from);
  void MergeFrom(const Cluster_LbSubsetConfig_LbSubsetSelector& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(Cluster_LbSubsetConfig_LbSubsetSelector* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fcds_2eproto::TableStruct;
  friend void ::protobuf_api_2fcds_2eproto::InitDefaultsCluster_LbSubsetConfig_LbSubsetSelectorImpl();
};
// -------------------------------------------------------------------

class Cluster_LbSubsetConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Cluster.LbSubsetConfig) */ {
 public:
  Cluster_LbSubsetConfig();
  virtual ~Cluster_LbSubsetConfig();

  Cluster_LbSubsetConfig(const Cluster_LbSubsetConfig& from);

  inline Cluster_LbSubsetConfig& operator=(const Cluster_LbSubsetConfig& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  Cluster_LbSubsetConfig(Cluster_LbSubsetConfig&& from) noexcept
    : Cluster_LbSubsetConfig() {
    *this = ::std::move(from);
  }

  inline Cluster_LbSubsetConfig& operator=(Cluster_LbSubsetConfig&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const Cluster_LbSubsetConfig& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Cluster_LbSubsetConfig* internal_default_instance() {
    return reinterpret_cast<const Cluster_LbSubsetConfig*>(
               &_Cluster_LbSubsetConfig_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    6;

  void Swap(Cluster_LbSubsetConfig* other);
  friend void swap(Cluster_LbSubsetConfig& a, Cluster_LbSubsetConfig& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline Cluster_LbSubsetConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  Cluster_LbSubsetConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const Cluster_LbSubsetConfig& from);
  void MergeFrom(const Cluster_LbSubsetConfig& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(Cluster_LbSubsetConfig* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  typedef Cluster_LbSubsetConfig_LbSubsetSelector LbSubsetSelector;

  typedef Cluster_LbSubsetConfig_LbSubsetFallbackPolicy LbSubsetFallbackPolicy;
  static const LbSubsetFallbackPolicy NO_FALLBACK =
    Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_NO_FALLBACK;
  static const LbSubsetFallbackPolicy ANY_ENDPOINT =
    Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_ANY_ENDPOINT;
  static const LbSubsetFallbackPolicy DEFAULT_SUBSET =
    Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_DEFAULT_SUBSET;
  static inline bool LbSubsetFallbackPolicy_IsValid(int value) {
    return Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_IsValid(value);
  }
  static const LbSubsetFallbackPolicy LbSubsetFallbackPolicy_MIN =
    Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_LbSubsetFallbackPolicy_MIN;
  static const LbSubsetFallbackPolicy LbSubsetFallbackPolicy_MAX =
    Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_LbSubsetFallbackPolicy_MAX;
  static const int LbSubsetFallbackPolicy_ARRAYSIZE =
    Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_LbSubsetFallbackPolicy_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  LbSubsetFallbackPolicy_descriptor() {
    return Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_descriptor();
  }
  static inline const ::std::string& LbSubsetFallbackPolicy_Name(LbSubsetFallbackPolicy value) {
    return Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_Name(value);
  }
  static inline bool LbSubsetFallbackPolicy_Parse(const ::std::string& name,
      LbSubsetFallbackPolicy* value) {
    return Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // repeated .envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector subset_selectors = 3;
  int subset_selectors_size() const;
  void clear_subset_selectors();
  static const int kSubsetSelectorsFieldNumber = 3;
  const ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector& subset_selectors(int index) const;
  ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector* mutable_subset_selectors(int index);
  ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector* add_subset_selectors();
  ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector >*
      mutable_subset_selectors();
  const ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector >&
      subset_selectors() const;

  // .google.protobuf.Struct default_subset = 2;
  bool has_default_subset() const;
  ...
  void clear_fallback_policy();
  static const int kFallbackPolicyFieldNumber = 1;
  ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetFallbackPolicy fallback_policy() const;
  void set_fallback_policy(::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetFallbackPolicy value);

  // @@protoc_insertion_point(class_scope:envoy.api.v2.Cluster.LbSubsetConfig)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector > subset_selectors_;
  ::google::protobuf::Struct* default_subset_;
  int fallback_policy_;
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fcds_2eproto::TableStruct;
  friend void ::protobuf_api_2fcds_2eproto::InitDefaultsCluster_LbSubsetConfigImpl();
};
// -------------------------------------------------------------------

class Cluster_RingHashLbConfig_DeprecatedV1 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1) */ {
 public:
  Cluster_RingHashLbConfig_DeprecatedV1();
  virtual ~Cluster_RingHashLbConfig_DeprecatedV1();

  Cluster_RingHashLbConfig_DeprecatedV1(const Cluster_RingHashLbConfig_DeprecatedV1& from);

  inline Cluster_RingHashLbConfig_DeprecatedV1& operator=(const Cluster_RingHashLbConfig_DeprecatedV1& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  Cluster_RingHashLbConfig_DeprecatedV1(Cluster_RingHashLbConfig_DeprecatedV1&& from) noexcept
    : Cluster_RingHashLbConfig_DeprecatedV1() {
    *this = ::std::move(from);
  }

  inline Cluster_RingHashLbConfig_DeprecatedV1& operator=(Cluster_RingHashLbConfig_DeprecatedV1&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const Cluster_RingHashLbConfig_DeprecatedV1& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Cluster_RingHashLbConfig_DeprecatedV1* internal_default_instance() {
    return reinterpret_cast<const Cluster_RingHashLbConfig_DeprecatedV1*>(
               &_Cluster_RingHashLbConfig_DeprecatedV1_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    7;

  void Swap(Cluster_RingHashLbConfig_DeprecatedV1* other);
  friend void swap(Cluster_RingHashLbConfig_DeprecatedV1& a, Cluster_RingHashLbConfig_DeprecatedV1& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline Cluster_RingHashLbConfig_DeprecatedV1* New() const PROTOBUF_FINAL { return New(NULL); }

  Cluster_RingHashLbConfig_DeprecatedV1* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const Cluster_RingHashLbConfig_DeprecatedV1& from);
  void MergeFrom(const Cluster_RingHashLbConfig_DeprecatedV1& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(Cluster_RingHashLbConfig_DeprecatedV1* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::BoolValue* use_std_hash_;
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fcds_2eproto::TableStruct;
  friend void ::protobuf_api_2fcds_2eproto::InitDefaultsCluster_RingHashLbConfig_DeprecatedV1Impl();
};
// -------------------------------------------------------------------

class Cluster_RingHashLbConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Cluster.RingHashLbConfig) */ {
 public:
  Cluster_RingHashLbConfig();
  virtual ~Cluster_RingHashLbConfig();

  Cluster_RingHashLbConfig(const Cluster_RingHashLbConfig& from);

  inline Cluster_RingHashLbConfig& operator=(const Cluster_RingHashLbConfig& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  Cluster_RingHashLbConfig(Cluster_RingHashLbConfig&& from) noexcept
    : Cluster_RingHashLbConfig() {
    *this = ::std::move(from);
  }

  inline Cluster_RingHashLbConfig& operator=(Cluster_RingHashLbConfig&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const Cluster_RingHashLbConfig& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Cluster_RingHashLbConfig* internal_default_instance() {
    return reinterpret_cast<const Cluster_RingHashLbConfig*>(
               &_Cluster_RingHashLbConfig_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    8;

  void Swap(Cluster_RingHashLbConfig* other);
  friend void swap(Cluster_RingHashLbConfig& a, Cluster_RingHashLbConfig& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline Cluster_RingHashLbConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  Cluster_RingHashLbConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const Cluster_RingHashLbConfig& from);
  void MergeFrom(const Cluster_RingHashLbConfig& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(Cluster_RingHashLbConfig* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  typedef Cluster_RingHashLbConfig_DeprecatedV1 DeprecatedV1;

  // accessors -------------------------------------------------------

  // .google.protobuf.UInt64Value minimum_ring_size = 1;
  bool has_minimum_ring_size() const;
 ...
 private:
  ...
  ::envoy::api::v2::Cluster_RingHashLbConfig_DeprecatedV1* deprecated_v1_;
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fcds_2eproto::TableStruct;
  friend void ::protobuf_api_2fcds_2eproto::InitDefaultsCluster_RingHashLbConfigImpl();
};
// -------------------------------------------------------------------
...
class Cluster : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Cluster) */ {
 public:
  ...
  typedef Cluster_LbSubsetConfig LbSubsetConfig;
  typedef Cluster_RingHashLbConfig RingHashLbConfig;
  ...
  bool has_lb_subset_config() const;
  ...
  bool has_ring_hash_lb_config() const;
  ...
  LbConfigCase lb_config_case() const;
 ...
 private:
  ...
  union LbConfigUnion {
    LbConfigUnion() {}
    ::envoy::api::v2::Cluster_RingHashLbConfig* ring_hash_lb_config_;
  } lb_config_;
  mutable int _cached_size_;
  ::google::protobuf::uint32 _oneof_case_[2];

  friend struct ::protobuf_api_2fcds_2eproto::TableStruct;
  friend void ::protobuf_api_2fcds_2eproto::InitDefaultsClusterImpl();
};
// ===================================================================
...
// repeated string keys = 1;
inline int Cluster_LbSubsetConfig_LbSubsetSelector::keys_size() const {
  return keys_.size();
}
inline void Cluster_LbSubsetConfig_LbSubsetSelector::clear_keys() {
  keys_.Clear();
}
inline const ::std::string& Cluster_LbSubsetConfig_LbSubsetSelector::keys(int index) const {
  // @@protoc_insertion_point(field_get:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
  return keys_.Get(index);
}
inline ::std::string* Cluster_LbSubsetConfig_LbSubsetSelector::mutable_keys(int index) {
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
  return keys_.Mutable(index);
}
inline void Cluster_LbSubsetConfig_LbSubsetSelector::set_keys(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
  keys_.Mutable(index)->assign(value);
}
#if LANG_CXX11
inline void Cluster_LbSubsetConfig_LbSubsetSelector::set_keys(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
  keys_.Mutable(index)->assign(std::move(value));
}
#endif
inline void Cluster_LbSubsetConfig_LbSubsetSelector::set_keys(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  keys_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
}
inline void Cluster_LbSubsetConfig_LbSubsetSelector::set_keys(int index, const char* value, size_t size) {
  keys_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
}
inline ::std::string* Cluster_LbSubsetConfig_LbSubsetSelector::add_keys() {
  // @@protoc_insertion_point(field_add_mutable:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
  return keys_.Add();
}
inline void Cluster_LbSubsetConfig_LbSubsetSelector::add_keys(const ::std::string& value) {
  keys_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
}
#if LANG_CXX11
inline void Cluster_LbSubsetConfig_LbSubsetSelector::add_keys(::std::string&& value) {
  keys_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
}
#endif
inline void Cluster_LbSubsetConfig_LbSubsetSelector::add_keys(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  keys_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
}
inline void Cluster_LbSubsetConfig_LbSubsetSelector::add_keys(const char* value, size_t size) {
  keys_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
Cluster_LbSubsetConfig_LbSubsetSelector::keys() const {
  // @@protoc_insertion_point(field_list:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
  return keys_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
Cluster_LbSubsetConfig_LbSubsetSelector::mutable_keys() {
  // @@protoc_insertion_point(field_mutable_list:envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.keys)
  return &keys_;
}
...
// .envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetFallbackPolicy fallback_policy = 1;
inline void Cluster_LbSubsetConfig::clear_fallback_policy() {
  fallback_policy_ = 0;
}
inline ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetFallbackPolicy Cluster_LbSubsetConfig::fallback_policy() const {
  // @@protoc_insertion_point(field_get:envoy.api.v2.Cluster.LbSubsetConfig.fallback_policy)
  return static_cast< ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetFallbackPolicy >(fallback_policy_);
}
inline void Cluster_LbSubsetConfig::set_fallback_policy(::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetFallbackPolicy value) {
  
  fallback_policy_ = value;
  // @@protoc_insertion_point(field_set:envoy.api.v2.Cluster.LbSubsetConfig.fallback_policy)
}
...
inline ::google::protobuf::Struct* Cluster_LbSubsetConfig::mutable_default_subset() {
  ...
  if (default_subset_ == NULL) {
    default_subset_ = new ::google::protobuf::Struct;
  }
...
// repeated .envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector subset_selectors = 3;
inline int Cluster_LbSubsetConfig::subset_selectors_size() const {
  return subset_selectors_.size();
}
inline void Cluster_LbSubsetConfig::clear_subset_selectors() {
  subset_selectors_.Clear();
}
inline const ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector& Cluster_LbSubsetConfig::subset_selectors(int index) const {
  // @@protoc_insertion_point(field_get:envoy.api.v2.Cluster.LbSubsetConfig.subset_selectors)
  return subset_selectors_.Get(index);
}
inline ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector* Cluster_LbSubsetConfig::mutable_subset_selectors(int index) {
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.Cluster.LbSubsetConfig.subset_selectors)
  return subset_selectors_.Mutable(index);
}
inline ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector* Cluster_LbSubsetConfig::add_subset_selectors() {
  // @@protoc_insertion_point(field_add:envoy.api.v2.Cluster.LbSubsetConfig.subset_selectors)
  return subset_selectors_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector >*
Cluster_LbSubsetConfig::mutable_subset_selectors() {
  // @@protoc_insertion_point(field_mutable_list:envoy.api.v2.Cluster.LbSubsetConfig.subset_selectors)
  return &subset_selectors_;
}
inline const ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetSelector >&
Cluster_LbSubsetConfig::subset_selectors() const {
  // @@protoc_insertion_point(field_list:envoy.api.v2.Cluster.LbSubsetConfig.subset_selectors)
  return subset_selectors_;
}
...
inline ::google::protobuf::BoolValue* Cluster_RingHashLbConfig_DeprecatedV1::mutable_use_std_hash() {
  ...
  if (use_std_hash_ == NULL) {
    use_std_hash_ = new ::google::protobuf::BoolValue;
  }
...
inline ::google::protobuf::UInt64Value* Cluster_RingHashLbConfig::mutable_minimum_ring_size() {
  ...
  if (minimum_ring_size_ == NULL) {
    minimum_ring_size_ = new ::google::protobuf::UInt64Value;
  }
...
// .envoy.api.v2.Cluster.RingHashLbConfig.DeprecatedV1 deprecated_v1 = 2;
inline bool Cluster_RingHashLbConfig::has_deprecated_v1() const {
...
inline const ::envoy::api::v2::Cluster_RingHashLbConfig_DeprecatedV1& Cluster_RingHashLbConfig::deprecated_v1() const {
  const ::envoy::api::v2::Cluster_RingHashLbConfig_DeprecatedV1* p = deprecated_v1_;
...
inline ::envoy::api::v2::Cluster_RingHashLbConfig_DeprecatedV1* Cluster_RingHashLbConfig::mutable_deprecated_v1() {
  ...
  if (deprecated_v1_ == NULL) {
    deprecated_v1_ = new ::envoy::api::v2::Cluster_RingHashLbConfig_DeprecatedV1;
  }
...
// .envoy.api.v2.Cluster.LbSubsetConfig lb_subset_config = 22;
inline bool Cluster::has_lb_subset_config() const {
...
inline const ::envoy::api::v2::Cluster_LbSubsetConfig& Cluster::lb_subset_config() const {
  const ::envoy::api::v2::Cluster_LbSubsetConfig* p = lb_subset_config_;
...
inline ::envoy::api::v2::Cluster_LbSubsetConfig* Cluster::mutable_lb_subset_config() {
  ...
  if (lb_subset_config_ == NULL) {
    lb_subset_config_ = new ::envoy::api::v2::Cluster_LbSubsetConfig;
  }
...
// .envoy.api.v2.Cluster.RingHashLbConfig ring_hash_lb_config = 23;
inline bool Cluster::has_ring_hash_lb_config() const {
  return lb_config_case() == kRingHashLbConfig;
}
inline void Cluster::set_has_ring_hash_lb_config() {
  _oneof_case_[1] = kRingHashLbConfig;
}
inline void Cluster::clear_ring_hash_lb_config() {
...
inline ::envoy::api::v2::Cluster_RingHashLbConfig* Cluster::mutable_ring_hash_lb_config() {
  if (!has_ring_hash_lb_config()) {
    ...
    lb_config_.ring_hash_lb_config_ = new ::envoy::api::v2::Cluster_RingHashLbConfig;
  }
...
inline bool Cluster::has_lb_config() const {
  return lb_config_case() != LB_CONFIG_NOT_SET;
}
inline void Cluster::clear_has_lb_config() {
...
inline Cluster::LbConfigCase Cluster::lb_config_case() const {
  return Cluster::LbConfigCase(_oneof_case_[1]);
}
#ifdef __GNUC__
...
template <> struct is_proto_enum< ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetFallbackPolicy> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetFallbackPolicy>() {
  return ::envoy::api::v2::Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_descriptor();
}
