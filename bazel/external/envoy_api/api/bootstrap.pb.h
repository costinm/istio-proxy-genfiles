...
inline void InitDefaults() {
  InitDefaultsLightstepConfig();
  InitDefaultsZipkinConfig();
  InitDefaultsTracing_Http();
  InitDefaultsTracing();
  InitDefaultsAdmin();
  InitDefaultsClusterManager_OutlierDetection();
  InitDefaultsClusterManager();
  InitDefaultsStatsdSink();
  InitDefaultsStatsSink();
  InitDefaultsTagSpecifier();
  InitDefaultsStatsConfig();
  InitDefaultsWatchdog();
  InitDefaultsRuntime();
  InitDefaultsRateLimitServiceConfig();
  InitDefaultsBootstrap_StaticResources();
  InitDefaultsBootstrap_DynamicResources_DeprecatedV1();
  InitDefaultsBootstrap_DynamicResources();
...
extern StatsConfigDefaultTypeInternal _StatsConfig_default_instance_;
class StatsSink;
...
extern TagSpecifierDefaultTypeInternal _TagSpecifier_default_instance_;
class Tracing;
...
class LightstepConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.LightstepConfig) */ {
 ...
 private:
  ...
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsLightstepConfigImpl();
};
// -------------------------------------------------------------------
...
class ZipkinConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.ZipkinConfig) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsZipkinConfigImpl();
};
// -------------------------------------------------------------------
...
class Tracing_Http : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Tracing.Http) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsTracing_HttpImpl();
};
// -------------------------------------------------------------------
...
class Tracing : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Tracing) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsTracingImpl();
};
// -------------------------------------------------------------------
...
class Admin : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Admin) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsAdminImpl();
};
// -------------------------------------------------------------------
...
class ClusterManager_OutlierDetection : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.ClusterManager.OutlierDetection) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsClusterManager_OutlierDetectionImpl();
};
// -------------------------------------------------------------------
...
class ClusterManager : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.ClusterManager) */ {
 public:
  ...
  bool has_load_stats_config() const;
  void clear_load_stats_config();
  static const int kLoadStatsConfigFieldNumber = 4;
  const ::envoy::api::v2::ApiConfigSource& load_stats_config() const;
  ::envoy::api::v2::ApiConfigSource* release_load_stats_config();
  ::envoy::api::v2::ApiConfigSource* mutable_load_stats_config();
  void set_allocated_load_stats_config(::envoy::api::v2::ApiConfigSource* load_stats_config);
 ...
 private:
  ...
  ::envoy::api::v2::ApiConfigSource* load_stats_config_;
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsClusterManagerImpl();
};
// -------------------------------------------------------------------
...
class StatsdSink : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.StatsdSink) */ {
 ...
 private:
  ...
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsStatsdSinkImpl();
};
// -------------------------------------------------------------------
...
class StatsSink : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.StatsSink) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsStatsSinkImpl();
};
// -------------------------------------------------------------------

class TagSpecifier : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.TagSpecifier) */ {
 public:
  TagSpecifier();
  virtual ~TagSpecifier();

  TagSpecifier(const TagSpecifier& from);

  inline TagSpecifier& operator=(const TagSpecifier& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  TagSpecifier(TagSpecifier&& from) noexcept
    : TagSpecifier() {
    *this = ::std::move(from);
  }

  inline TagSpecifier& operator=(TagSpecifier&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const TagSpecifier& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const TagSpecifier* internal_default_instance() {
    return reinterpret_cast<const TagSpecifier*>(
               &_TagSpecifier_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    9;

  void Swap(TagSpecifier* other);
  friend void swap(TagSpecifier& a, TagSpecifier& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline TagSpecifier* New() const PROTOBUF_FINAL { return New(NULL); }

  TagSpecifier* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const TagSpecifier& from);
  void MergeFrom(const TagSpecifier& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(TagSpecifier* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:envoy.api.v2.TagSpecifier)
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsTagSpecifierImpl();
};
// -------------------------------------------------------------------

class StatsConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.StatsConfig) */ {
 public:
  StatsConfig();
  virtual ~StatsConfig();

  StatsConfig(const StatsConfig& from);

  inline StatsConfig& operator=(const StatsConfig& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  StatsConfig(StatsConfig&& from) noexcept
    : StatsConfig() {
    *this = ::std::move(from);
  }

  inline StatsConfig& operator=(StatsConfig&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const StatsConfig& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const StatsConfig* internal_default_instance() {
    return reinterpret_cast<const StatsConfig*>(
               &_StatsConfig_default_instance_);
  }
  static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
    10;

  void Swap(StatsConfig* other);
  friend void swap(StatsConfig& a, StatsConfig& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline StatsConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  StatsConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const StatsConfig& from);
  void MergeFrom(const StatsConfig& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(StatsConfig* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  int stats_tags_size() const;
  void clear_stats_tags();
  static const int kStatsTagsFieldNumber = 1;
  const ::envoy::api::v2::TagSpecifier& stats_tags(int index) const;
  ::envoy::api::v2::TagSpecifier* mutable_stats_tags(int index);
  ::envoy::api::v2::TagSpecifier* add_stats_tags();
  ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::TagSpecifier >*
      mutable_stats_tags();
  const ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::TagSpecifier >&
      stats_tags() const;

  // .google.protobuf.BoolValue use_all_default_tags = 2;
  bool has_use_all_default_tags() const;
  void clear_use_all_default_tags();
  static const int kUseAllDefaultTagsFieldNumber = 2;
  const ::google::protobuf::BoolValue& use_all_default_tags() const;
  ::google::protobuf::BoolValue* release_use_all_default_tags();
  ::google::protobuf::BoolValue* mutable_use_all_default_tags();
  void set_allocated_use_all_default_tags(::google::protobuf::BoolValue* use_all_default_tags);

  // @@protoc_insertion_point(class_scope:envoy.api.v2.StatsConfig)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::TagSpecifier > stats_tags_;
  ::google::protobuf::BoolValue* use_all_default_tags_;
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsStatsConfigImpl();
};
// -------------------------------------------------------------------
...
class Watchdog : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Watchdog) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsWatchdogImpl();
};
// -------------------------------------------------------------------
...
class Runtime : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Runtime) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsRuntimeImpl();
};
// -------------------------------------------------------------------
...
class RateLimitServiceConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.RateLimitServiceConfig) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsRateLimitServiceConfigImpl();
};
// -------------------------------------------------------------------
...
class Bootstrap_StaticResources : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Bootstrap.StaticResources) */ {
 public:
  ...
  void clear_secrets();
  static const int kSecretsFieldNumber = 3;
  const ::envoy::api::v2::Secret& secrets(int index) const;
  ::envoy::api::v2::Secret* mutable_secrets(int index);
  ::envoy::api::v2::Secret* add_secrets();
  ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Secret >*
      mutable_secrets();
  const ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Secret >&
      secrets() const;
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Secret > secrets_;
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsBootstrap_StaticResourcesImpl();
};
// -------------------------------------------------------------------
...
class Bootstrap_DynamicResources_DeprecatedV1 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Bootstrap.DynamicResources.DeprecatedV1) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsBootstrap_DynamicResources_DeprecatedV1Impl();
};
// -------------------------------------------------------------------
...
class Bootstrap_DynamicResources : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Bootstrap.DynamicResources) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsBootstrap_DynamicResourcesImpl();
};
// -------------------------------------------------------------------
...
class Bootstrap : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:envoy.api.v2.Bootstrap) */ {
 public:
  ...
  bool has_stats_config() const;
  void clear_stats_config();
  static const int kStatsConfigFieldNumber = 13;
  const ::envoy::api::v2::StatsConfig& stats_config() const;
  ::envoy::api::v2::StatsConfig* release_stats_config();
  ::envoy::api::v2::StatsConfig* mutable_stats_config();
  void set_allocated_stats_config(::envoy::api::v2::StatsConfig* stats_config);
 ...
 private:
  ...
  ::envoy::api::v2::StatsConfig* stats_config_;
  mutable int _cached_size_;
  friend struct ::protobuf_api_2fbootstrap_2eproto::TableStruct;
  friend void ::protobuf_api_2fbootstrap_2eproto::InitDefaultsBootstrapImpl();
};
// ===================================================================
...
// .envoy.api.v2.ApiConfigSource load_stats_config = 4;
inline bool ClusterManager::has_load_stats_config() const {
  return this != internal_default_instance() && load_stats_config_ != NULL;
}
inline const ::envoy::api::v2::ApiConfigSource& ClusterManager::load_stats_config() const {
  const ::envoy::api::v2::ApiConfigSource* p = load_stats_config_;
  // @@protoc_insertion_point(field_get:envoy.api.v2.ClusterManager.load_stats_config)
  return p != NULL ? *p : *reinterpret_cast<const ::envoy::api::v2::ApiConfigSource*>(
      &::envoy::api::v2::_ApiConfigSource_default_instance_);
}
inline ::envoy::api::v2::ApiConfigSource* ClusterManager::release_load_stats_config() {
  // @@protoc_insertion_point(field_release:envoy.api.v2.ClusterManager.load_stats_config)
  
  ::envoy::api::v2::ApiConfigSource* temp = load_stats_config_;
  load_stats_config_ = NULL;
  return temp;
}
inline ::envoy::api::v2::ApiConfigSource* ClusterManager::mutable_load_stats_config() {
  
  if (load_stats_config_ == NULL) {
    load_stats_config_ = new ::envoy::api::v2::ApiConfigSource;
  }
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.ClusterManager.load_stats_config)
  return load_stats_config_;
}
inline void ClusterManager::set_allocated_load_stats_config(::envoy::api::v2::ApiConfigSource* load_stats_config) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(load_stats_config_);
  }
  if (load_stats_config) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      load_stats_config = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, load_stats_config, submessage_arena);
    }
    
  } else {
    
  }
  load_stats_config_ = load_stats_config;
  // @@protoc_insertion_point(field_set_allocated:envoy.api.v2.ClusterManager.load_stats_config)
}
...
inline const ::envoy::api::v2::Address& StatsdSink::address() const {
  ...
  return has_address()
      ...
      : *reinterpret_cast< ::envoy::api::v2::Address*>(&::envoy::api::v2::_Address_default_instance_);
}
...
// string tag_name = 1;
inline void TagSpecifier::clear_tag_name() {
  tag_name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& TagSpecifier::tag_name() const {
  // @@protoc_insertion_point(field_get:envoy.api.v2.TagSpecifier.tag_name)
  return tag_name_.GetNoArena();
}
inline void TagSpecifier::set_tag_name(const ::std::string& value) {
  
  tag_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:envoy.api.v2.TagSpecifier.tag_name)
}
#if LANG_CXX11
inline void TagSpecifier::set_tag_name(::std::string&& value) {
  
  tag_name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:envoy.api.v2.TagSpecifier.tag_name)
}
#endif
inline void TagSpecifier::set_tag_name(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  tag_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:envoy.api.v2.TagSpecifier.tag_name)
}
inline void TagSpecifier::set_tag_name(const char* value, size_t size) {
  
  tag_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:envoy.api.v2.TagSpecifier.tag_name)
}
inline ::std::string* TagSpecifier::mutable_tag_name() {
  
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.TagSpecifier.tag_name)
  return tag_name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TagSpecifier::release_tag_name() {
  // @@protoc_insertion_point(field_release:envoy.api.v2.TagSpecifier.tag_name)
  
  return tag_name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void TagSpecifier::set_allocated_tag_name(::std::string* tag_name) {
  if (tag_name != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:envoy.api.v2.TagSpecifier.tag_name)
}

// string regex = 2;
inline void TagSpecifier::clear_regex() {
  regex_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& TagSpecifier::regex() const {
  // @@protoc_insertion_point(field_get:envoy.api.v2.TagSpecifier.regex)
  return regex_.GetNoArena();
}
inline void TagSpecifier::set_regex(const ::std::string& value) {
  
  regex_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:envoy.api.v2.TagSpecifier.regex)
}
#if LANG_CXX11
inline void TagSpecifier::set_regex(::std::string&& value) {
  
  regex_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:envoy.api.v2.TagSpecifier.regex)
}
#endif
inline void TagSpecifier::set_regex(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  regex_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:envoy.api.v2.TagSpecifier.regex)
}
inline void TagSpecifier::set_regex(const char* value, size_t size) {
  
  regex_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:envoy.api.v2.TagSpecifier.regex)
}
inline ::std::string* TagSpecifier::mutable_regex() {
  
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.TagSpecifier.regex)
  return regex_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TagSpecifier::release_regex() {
  // @@protoc_insertion_point(field_release:envoy.api.v2.TagSpecifier.regex)
  
  return regex_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void TagSpecifier::set_allocated_regex(::std::string* regex) {
  if (regex != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:envoy.api.v2.TagSpecifier.regex)
}
...
// repeated .envoy.api.v2.TagSpecifier stats_tags = 1;
inline int StatsConfig::stats_tags_size() const {
  return stats_tags_.size();
}
inline void StatsConfig::clear_stats_tags() {
  stats_tags_.Clear();
}
inline const ::envoy::api::v2::TagSpecifier& StatsConfig::stats_tags(int index) const {
  // @@protoc_insertion_point(field_get:envoy.api.v2.StatsConfig.stats_tags)
  return stats_tags_.Get(index);
}
inline ::envoy::api::v2::TagSpecifier* StatsConfig::mutable_stats_tags(int index) {
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.StatsConfig.stats_tags)
  return stats_tags_.Mutable(index);
}
inline ::envoy::api::v2::TagSpecifier* StatsConfig::add_stats_tags() {
  // @@protoc_insertion_point(field_add:envoy.api.v2.StatsConfig.stats_tags)
  return stats_tags_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::TagSpecifier >*
StatsConfig::mutable_stats_tags() {
  // @@protoc_insertion_point(field_mutable_list:envoy.api.v2.StatsConfig.stats_tags)
  return &stats_tags_;
}
inline const ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::TagSpecifier >&
StatsConfig::stats_tags() const {
  // @@protoc_insertion_point(field_list:envoy.api.v2.StatsConfig.stats_tags)
  return stats_tags_;
}

// .google.protobuf.BoolValue use_all_default_tags = 2;
inline bool StatsConfig::has_use_all_default_tags() const {
  return this != internal_default_instance() && use_all_default_tags_ != NULL;
}
inline const ::google::protobuf::BoolValue& StatsConfig::use_all_default_tags() const {
  const ::google::protobuf::BoolValue* p = use_all_default_tags_;
  // @@protoc_insertion_point(field_get:envoy.api.v2.StatsConfig.use_all_default_tags)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::BoolValue*>(
      &::google::protobuf::_BoolValue_default_instance_);
}
inline ::google::protobuf::BoolValue* StatsConfig::release_use_all_default_tags() {
  // @@protoc_insertion_point(field_release:envoy.api.v2.StatsConfig.use_all_default_tags)
  
  ::google::protobuf::BoolValue* temp = use_all_default_tags_;
  use_all_default_tags_ = NULL;
  return temp;
}
inline ::google::protobuf::BoolValue* StatsConfig::mutable_use_all_default_tags() {
  
  if (use_all_default_tags_ == NULL) {
    use_all_default_tags_ = new ::google::protobuf::BoolValue;
  }
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.StatsConfig.use_all_default_tags)
  return use_all_default_tags_;
}
inline void StatsConfig::set_allocated_use_all_default_tags(::google::protobuf::BoolValue* use_all_default_tags) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(use_all_default_tags_);
  }
  if (use_all_default_tags) {
    ::google::protobuf::Arena* submessage_arena =
      reinterpret_cast< ::google::protobuf::MessageLite*>(use_all_default_tags)->GetArena();
    if (message_arena != submessage_arena) {
      use_all_default_tags = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, use_all_default_tags, submessage_arena);
    }
    
  } else {
    
  }
  use_all_default_tags_ = use_all_default_tags;
  // @@protoc_insertion_point(field_set_allocated:envoy.api.v2.StatsConfig.use_all_default_tags)
}
...
inline void Watchdog::set_allocated_miss_timeout(::google::protobuf::Duration* miss_timeout) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(miss_timeout_);
  }
  if (miss_timeout) {
    ::google::protobuf::Arena* submessage_arena =
      reinterpret_cast< ::google::protobuf::MessageLite*>(miss_timeout)->GetArena();
    if (message_arena != submessage_arena) {
      miss_timeout = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, miss_timeout, submessage_arena);
    }
...
inline void Watchdog::set_allocated_megamiss_timeout(::google::protobuf::Duration* megamiss_timeout) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(megamiss_timeout_);
  }
  if (megamiss_timeout) {
    ::google::protobuf::Arena* submessage_arena =
      reinterpret_cast< ::google::protobuf::MessageLite*>(megamiss_timeout)->GetArena();
    if (message_arena != submessage_arena) {
      megamiss_timeout = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, megamiss_timeout, submessage_arena);
    }
...
inline void Watchdog::set_allocated_kill_timeout(::google::protobuf::Duration* kill_timeout) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(kill_timeout_);
  }
  if (kill_timeout) {
    ::google::protobuf::Arena* submessage_arena =
      reinterpret_cast< ::google::protobuf::MessageLite*>(kill_timeout)->GetArena();
    if (message_arena != submessage_arena) {
      kill_timeout = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, kill_timeout, submessage_arena);
    }
...
inline void Watchdog::set_allocated_multikill_timeout(::google::protobuf::Duration* multikill_timeout) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(multikill_timeout_);
  }
  if (multikill_timeout) {
    ::google::protobuf::Arena* submessage_arena =
      reinterpret_cast< ::google::protobuf::MessageLite*>(multikill_timeout)->GetArena();
    if (message_arena != submessage_arena) {
      multikill_timeout = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, multikill_timeout, submessage_arena);
    }
...
// repeated .envoy.api.v2.Secret secrets = 3;
inline int Bootstrap_StaticResources::secrets_size() const {
  return secrets_.size();
}
inline const ::envoy::api::v2::Secret& Bootstrap_StaticResources::secrets(int index) const {
  // @@protoc_insertion_point(field_get:envoy.api.v2.Bootstrap.StaticResources.secrets)
  return secrets_.Get(index);
}
inline ::envoy::api::v2::Secret* Bootstrap_StaticResources::mutable_secrets(int index) {
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.Bootstrap.StaticResources.secrets)
  return secrets_.Mutable(index);
}
inline ::envoy::api::v2::Secret* Bootstrap_StaticResources::add_secrets() {
  // @@protoc_insertion_point(field_add:envoy.api.v2.Bootstrap.StaticResources.secrets)
  return secrets_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Secret >*
Bootstrap_StaticResources::mutable_secrets() {
  // @@protoc_insertion_point(field_mutable_list:envoy.api.v2.Bootstrap.StaticResources.secrets)
  return &secrets_;
}
inline const ::google::protobuf::RepeatedPtrField< ::envoy::api::v2::Secret >&
Bootstrap_StaticResources::secrets() const {
  // @@protoc_insertion_point(field_list:envoy.api.v2.Bootstrap.StaticResources.secrets)
  return secrets_;
}
...
inline void Bootstrap_DynamicResources::set_allocated_lds_config(::envoy::api::v2::ConfigSource* lds_config) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(lds_config_);
  }
  if (lds_config) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      lds_config = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, lds_config, submessage_arena);
    }
...
inline void Bootstrap_DynamicResources::set_allocated_cds_config(::envoy::api::v2::ConfigSource* cds_config) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(cds_config_);
  }
  if (cds_config) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      cds_config = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, cds_config, submessage_arena);
    }
...
inline void Bootstrap_DynamicResources::set_allocated_ads_config(::envoy::api::v2::ApiConfigSource* ads_config) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(ads_config_);
  }
  if (ads_config) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      ads_config = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, ads_config, submessage_arena);
    }
...
inline void Bootstrap::set_allocated_static_resources(::envoy::api::v2::Bootstrap_StaticResources* static_resources) {
  ...
  if (static_resources) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      static_resources = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, static_resources, submessage_arena);
    }
...
inline void Bootstrap::set_allocated_dynamic_resources(::envoy::api::v2::Bootstrap_DynamicResources* dynamic_resources) {
  ...
  if (dynamic_resources) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      dynamic_resources = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, dynamic_resources, submessage_arena);
    }
...
inline void Bootstrap::set_allocated_cluster_manager(::envoy::api::v2::ClusterManager* cluster_manager) {
  ...
  if (cluster_manager) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      cluster_manager = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, cluster_manager, submessage_arena);
    }
...
// .envoy.api.v2.StatsConfig stats_config = 13;
inline bool Bootstrap::has_stats_config() const {
  return this != internal_default_instance() && stats_config_ != NULL;
}
inline void Bootstrap::clear_stats_config() {
  if (GetArenaNoVirtual() == NULL && stats_config_ != NULL) {
    delete stats_config_;
  }
  stats_config_ = NULL;
}
inline const ::envoy::api::v2::StatsConfig& Bootstrap::stats_config() const {
  const ::envoy::api::v2::StatsConfig* p = stats_config_;
  // @@protoc_insertion_point(field_get:envoy.api.v2.Bootstrap.stats_config)
  return p != NULL ? *p : *reinterpret_cast<const ::envoy::api::v2::StatsConfig*>(
      &::envoy::api::v2::_StatsConfig_default_instance_);
}
inline ::envoy::api::v2::StatsConfig* Bootstrap::release_stats_config() {
  // @@protoc_insertion_point(field_release:envoy.api.v2.Bootstrap.stats_config)
  
  ::envoy::api::v2::StatsConfig* temp = stats_config_;
  stats_config_ = NULL;
  return temp;
}
inline ::envoy::api::v2::StatsConfig* Bootstrap::mutable_stats_config() {
  
  if (stats_config_ == NULL) {
    stats_config_ = new ::envoy::api::v2::StatsConfig;
  }
  // @@protoc_insertion_point(field_mutable:envoy.api.v2.Bootstrap.stats_config)
  return stats_config_;
}
inline void Bootstrap::set_allocated_stats_config(::envoy::api::v2::StatsConfig* stats_config) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete stats_config_;
  }
  if (stats_config) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      stats_config = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, stats_config, submessage_arena);
    }
    
  } else {
    
  }
  stats_config_ = stats_config;
  // @@protoc_insertion_point(field_set_allocated:envoy.api.v2.Bootstrap.stats_config)
}
...
inline void Bootstrap::set_allocated_stats_flush_interval(::google::protobuf::Duration* stats_flush_interval) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(stats_flush_interval_);
  }
  if (stats_flush_interval) {
    ::google::protobuf::Arena* submessage_arena =
      reinterpret_cast< ::google::protobuf::MessageLite*>(stats_flush_interval)->GetArena();
    if (message_arena != submessage_arena) {
      stats_flush_interval = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, stats_flush_interval, submessage_arena);
    }
...
inline void Bootstrap::set_allocated_watchdog(::envoy::api::v2::Watchdog* watchdog) {
  ...
  if (watchdog) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      watchdog = ::google::protobuf::internal::GetOwnedMessage(
...
inline void Bootstrap::set_allocated_rate_limit_service(::envoy::api::v2::RateLimitServiceConfig* rate_limit_service) {
  ...
  if (rate_limit_service) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      rate_limit_service = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, rate_limit_service, submessage_arena);
    }
