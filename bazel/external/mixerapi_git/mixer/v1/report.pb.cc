...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::istio::mixer::v1::ReportRequest)},
  { 8, -1, sizeof(::istio::mixer::v1::ReportResponse)},
};
...
ReportRequest::ReportRequest()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_mixer_2fv1_2freport_2eproto::InitDefaultsReportRequest();
  }
  SharedCtor();
...
ReportResponse::ReportResponse()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_mixer_2fv1_2freport_2eproto::InitDefaultsReportResponse();
  }
  SharedCtor();
