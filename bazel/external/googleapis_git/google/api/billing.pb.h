...
class BillingStatusRule : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.BillingStatusRule) */ {
 public:
  ...
  #if LANG_CXX11
  BillingStatusRule(BillingStatusRule&& from) noexcept
    : BillingStatusRule() {
    *this = ::std::move(from);
  }

  inline BillingStatusRule& operator=(BillingStatusRule&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(BillingStatusRule& a, BillingStatusRule& b) {
    a.Swap(&b);
  }
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_google_2fapi_2fbilling_2eproto::TableStruct;
  friend void ::protobuf_google_2fapi_2fbilling_2eproto::InitDefaultsBillingStatusRuleImpl();
};
// ===================================================================
